/**
 * src/app/icon.svg (qora fon, oq "A" belgisi) dan:
 *   src/app/favicon.ico (16/32/48) va src/app/apple-icon.png (180)
 * Belgini o'zgartirish: icon.svg ni tahrirlang → `npm run icons`.
 */
...
await writeFile("test-results/favicon-preview.png", await png(256));
console.log("✔ favicon.ico, apple-icon.png (manba: src/app/icon.svg)");
